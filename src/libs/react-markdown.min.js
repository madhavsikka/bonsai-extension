;(function (g, f) {
  ...
  var ReactMarkdown = (() => {
    ...
    var ye = (e, n) => () => (
      ...
      tt = (e, n) => {
        for (var t in n) tn(e, t, { get: n[t], enumerable: !0 })
      },
      gr = (e, n, t, r) => {
    ...
    var Pe = (e, n, t) => (
        ...
        gr(
          n || !e || !e.__esModule
            ? tn(t, "default", { value: e, enumerable: !0 })
            : t,
          e
        )
      ),
      il = (e) => gr(tn({}, "__esModule", { value: !0 }), e)
    var Fr = ye((_) => {
      "use strict"
      ...
      function Ir(e, n, t) {
        var r,
          ...
          l = null
        if (n != null)
          for (r in (n.ref !== void 0 && (l = n.ref),
          n.key !== void 0 && (o = "" + n.key),
          n))
            Ar.call(n, r) && !Pr.hasOwnProperty(r) && (i[r] = n[r])
      ...
      function yn(e, n, t, r, i) {
        ...
        else if (((a = dl(e)), typeof a == "function"))
          for (e = a.call(e), u = 0; !(o = e.next()).done; )
            (o = o.value), (a = r + rt(o, u++)), (l += yn(o, n, t, a, i))
        else if (o === "object")
          throw (
            ((n = String(e)),
            Error(
      ...
      _.cloneElement = function (e, n, t) {
        ...
        if (n != null) {
          if (
            (n.ref !== void 0 && ((o = n.ref), (l = lt.current)),
      ...
      _.memo = function (e, n) {
        return { $$typeof: ml, type: e, compare: n === void 0 ? null : n }
      }
    ...
    var $r = ye((xs, Vr) => {
        ...
        jr = function (n) {
          ...
          var t = kn.call(n, "constructor"),
            r =
              ...
              kn.call(n.constructor.prototype, "isPrototypeOf")
      ...
      Vr.exports = function e() {
        var n,
          ...
          s = !1
        for (
          typeof u == "boolean" && ((s = u), (u = arguments[1] || {}), (a = 2)),
                ...
                u !== i &&
                  (s && i && (jr(i) || (o = Mr(i)))
                    ? (o
                        ? ((o = !1), (l = r && Mr(r) ? r : []))
                        : (l = r && jr(r) ? r : {}),
                      Ur(u, { name: t, newValue: e(s, l, i) }))
                    : typeof i != "undefined" &&
                      Ur(u, { name: t, newValue: i }))
        return u
      }
    })
    var co = ye((Nh, so) => {
...
`,
      ...
      Ro.exports = function (e, n) {
        ...
        function m() {
          ...
          if (!(vo != e.charAt(0) || Do != e.charAt(1))) {
            for (
              var w = 2;
              Ue != e.charAt(w) && (Do != e.charAt(w) || vo != e.charAt(w + 1));

            )
              ++w
            if (((w += 2), Ue === e.charAt(w - 1)))
    ...
    var $a = {}
    tt($a, { default: () => lr, uriTransformer: () => dn })
    ...
    var te = class extends Error {
      constructor(n, t, r) {
        ...
        if (
          ...
          l === -1
            ? (i[1] = r)
            : ((i[0] = r.slice(0, l)), (i[1] = r.slice(l + 1)))
        }
        t &&
    ...
    var xe = { basename: bl, dirname: wl, extname: Sl, join: El, sep: "/" }
    function bl(e, n) {
    ...
    function El(...e) {
      let n = -1,
        t
      for (; ++n < e.length; )
        on(e[n]), e[n] && (t = t === void 0 ? e[n] : t + "/" + e[n])
    ...
    var pt = ["history", "path", "basename", "stem", "extname", "dirname"],
      ze = class {
        ...
        set dirname(n) {
          Rr(this.basename, "dirname"),
            (this.path = xe.join(n || "", this.basename))
        }
        get basename() {
        ...
        set basename(n) {
          mt(n, "basename"),
            ft(n, "basename"),
            (this.path = xe.join(this.dirname || "", n))
        }
        get extname() {
        ...
        get stem() {
          return typeof this.path == "string"
            ? xe.basename(this.path, this.extname)
            : void 0
        }
        set stem(n) {
          mt(n, "stem"),
            ft(n, "stem"),
            (this.path = xe.join(this.dirname || "", n + (this.extname || "")))
        }
        toString(n) {
    ...
    function ft(e, n) {
      if (e && e.includes(xe.sep))
        throw new Error(
          "`" + n + "` cannot be a path: did not expect `" + xe.sep + "`"
        )
    }
    function mt(e, n) {
    ...
    function Zr() {
      ...
      function a(b, ...w) {
        ...
        function z(x, T) {
          ...
          N
            ? (ln(N[1]) && ln(T) && (T = (0, xt.default)(!0, N[1], T)),
              (N[1] = T))
            : n.push([...arguments])
        }
      }
      function f(b) {
        ...
        return (
          dt("parse", y),
          Qr(y, "parse") ? new y(String(w), w).parse() : y(String(w), w)
        )
      }
      function s(b, w) {
        o.freeze()
        ...
        return (
          gt("stringify", v),
          Xr(b),
          Qr(v, "compile") ? new v(b, y).compile() : v(b, y)
        )
      }
      function d(b, w, y) {
        if (
          (Xr(b),
          o.freeze(),
          !y && typeof w == "function" && ((y = w), (w = void 0)),
          !y)
        )
      ...
      function h(b, w) {
        if (
          (o.freeze(), dt("process", o.Parser), gt("process", o.Compiler), !w)
        )
    ...
    function Qr(e, n) {
      return (
        typeof e == "function" &&
        e.prototype &&
        (Tl(e.prototype) || n in e.prototype)
      )
    }
    function Tl(e) {
      let n
    ...
    function ne(e, n, t, r) {
      ...
      if (
        ...
        for (t && [].splice.apply(e, [n, t]); o < r.length; )
          (l = r.slice(o, o + 1e4)),
            l.unshift(n, 0),
            [].splice.apply(e, l),
            (o += 1e4),
    ...
    function Bl(e) {
      ...
      function o(u) {
        let a = e.enter("chunkText", { contentType: "text", previous: t })
    ...
    function Nl(e) {
      ...
      function a(C) {
        if ((r++, n.containerState._closeFlow)) {
          ...
          return (
            ne(n.events, z + 1, 0, n.events.slice(B)),
            (n.events.length = T),
            f(C)
          )
        }
      ...
      function w(C, B) {
        ...
        if (
          ...
          for (y(r), x = T; x < n.events.length; )
            (n.events[x][1].end = Object.assign({}, Z)), x++
    ...
    var cn = { name: "attention", tokenize: Ul, resolveAll: jl }
    function jl(e, n) {
      let t = -1,
        r,
        i,
          ...
          for (r = t; r--; )
            if (
              ...
              pi(d, -a),
                ...
                (f = ue(
                  f,
                  Qe(n.parser.constructs.insideSpan.null, e.slice(r + 1, t), n)
                )),
                (f = ue(f, [
                  ["exit", o, n],
                  ["enter", u, n],
    ...
    function Ul(e, n) {
      ...
      function u(a) {
        ...
        return (
          (f._open = !!(o === 42 ? d : d && (i || !m))),
          (f._close = !!(o === 42 ? m : m && (s || !d))),
          n(a)
        )
      }
    }
    ...
    var Et = { name: "autolink", tokenize: Hl }
    function Hl(e, n, t) {
      let r = 1
      return i
      function i(k) {
      ...
      function u(k) {
        return k === 58
          ? (e.consume(k), a)
          : (k === 43 || k === 45 || k === 46 || G(k)) && r++ < 32
          ? (e.consume(k), u)
          : f(k)
      }
      function a(k) {
        return k === 62
          ? (e.exit("autolinkProtocol"), h(k))
          : k === null || k === 32 || k === 60 || sn(k)
          ? t(k)
          : (e.consume(k), a)
      }
      function f(k) {
      ...
      function d(k) {
        return k === 46
          ? (e.consume(k), (r = 0), s)
          : k === 62
          ? ((e.exit("autolinkProtocol").type = "autolinkEmail"), h(k))
          : m(k)
      }
      function m(k) {
        return (k === 45 || G(k)) && r++ < 63
          ? (e.consume(k), k === 45 ? m : d)
          : t(k)
      }
      function h(k) {
        return (
    ...
    var wn = { name: "characterEscape", tokenize: Ql }
    function Ql(e, n, t) {
      return r
      function r(o) {
        return (
    ...
    var Sn = { name: "characterReference", tokenize: Xl }
    function Xl(e, n, t) {
      let r = this,
        i = 0,
        o,
      ...
      function a(d) {
        return d === 35
          ? (e.enter("characterReferenceMarkerNumeric"),
            ...
            f)
          : (e.enter("characterReferenceValue"), (o = 31), (l = G), s(d))
      }
      function f(d) {
        return d === 88 || d === 120
          ? (e.enter("characterReferenceMarkerHexadecimal"),
            ...
            (l = ii),
            s)
          : (e.enter("characterReferenceValue"), (o = 7), (l = an), s(d))
      }
      function s(d) {
        let m
        return d === 59 && i
          ? ((m = e.exit("characterReferenceValue")),
            l === G && !Xe(r.sliceSerialize(m))
              ? t(d)
              : (e.enter("characterReferenceMarker"),
                e.consume(d),
                e.exit("characterReferenceMarker"),
    ...
    var En = { name: "codeFenced", tokenize: Yl, concrete: !0 }
    function Yl(e, n, t) {
      let r = this,
        i = { tokenize: z, partial: !0 },
        o = { tokenize: B, partial: !0 },
      ...
      function b(x) {
        return x === null || A(x)
          ? (e.exit("chunkString"), e.exit("codeFencedFenceMeta"), w(x))
          : x === 96 && x === f
          ? t(x)
          : (e.consume(x), b)
      }
      ...
      function y(x) {
        return x === null
          ...
          ? e.attempt(
              o,
              e.attempt(i, C, u ? O(e, y, "linePrefix", u + 1) : y),
              C
            )(x)
          : (e.enter("codeFlowValue"), v(x))
      }
      function v(x) {
        return x === null || A(x)
          ? (e.exit("codeFlowValue"), y(x))
          : (e.consume(x), v)
      }
      function C(x) {
      ...
      function z(x, T, R) {
        ...
        function Z(P) {
          return (
            x.enter("codeFencedFence"), x.enter("codeFencedFenceSequence"), D(P)
          )
        }
        function D(P) {
          return P === f
            ...
            : N < a
            ? R(P)
            : (x.exit("codeFencedFenceSequence"), O(x, $, "whitespace")(P))
        }
        function $(P) {
    ...
    var pn = { name: "codeIndented", tokenize: Gl },
    ...
    function Gl(e, n, t) {
      ...
      function l(f) {
        return f === null
          ...
          : A(f)
          ? e.attempt(Kl, l, a)(f)
          : (e.enter("codeFlowValue"), u(f))
      }
      function u(f) {
        return f === null || A(f)
          ? (e.exit("codeFlowValue"), l(f))
          : (e.consume(f), u)
      }
      function a(f) {
    ...
    var Ct = { name: "codeText", tokenize: nu, resolve: Jl, previous: eu }
    function Jl(e) {
      let n = e.length - 4,
        t = 3,
        r,
    ...
    function nu(e, n, t) {
      ...
      function a(m) {
        return m === 96
          ? (e.consume(m), i++, a)
          : (e.exit("codeTextSequence"), f(m))
      }
      function f(m) {
        return m === null
          ? t(m)
          : m === 96
          ? ((l = e.enter("codeTextSequence")), (o = 0), d(m))
          : m === 32
          ? (e.enter("space"), e.consume(m), e.exit("space"), f)
          : A(m)
          ? (e.enter("lineEnding"), e.consume(m), e.exit("lineEnding"), f)
          : (e.enter("codeTextData"), s(m))
      }
      function s(m) {
        return m === null || m === 32 || m === 96 || A(m)
          ? (e.exit("codeTextData"), f(m))
          : (e.consume(m), s)
      }
      function d(m) {
        return m === 96
      ...
      for (; ++t < e.length; ) {
        ...
        if (
          ...
          for (; ++o < a.length && a[o][1].type !== "content"; )
            a[o][1].type === "chunkText" &&
              ((a[o][1]._isInFirstContentOfListItem = !0), o++)
        if (r[0] === "enter")
          r[1].contentType && (Object.assign(n, tu(e, t)), (t = n[t]), (f = !0))
    ...
    function tu(e, n) {
      ...
      for (h = t; ++m < u.length; )
        u[m][0] === "exit" &&
          u[m - 1][0] === "enter" &&
          u[m][1].type === u[m - 1][1].type &&
          u[m][1].start.line !== u[m][1].end.line &&
          ((b = m + 1),
          w.push(b),
          (h._tokenizer = void 0),
          (h.previous = void 0),
      ...
      for (
        l.events = [],
          h ? ((h._tokenizer = void 0), (h.previous = void 0)) : w.pop(),
          m = w.length;
        m--;
      ...
      for (m = -1; ++m < a.length; )
        (f[k + a[m][0]] = k + a[m][1]), (k += a[m][1] - a[m][0] - 1)
      return f
    }
    var At = { tokenize: ou, resolve: iu },
      ru = { tokenize: lu, partial: !0 }
    function iu(e) {
      return Cn(e), e
    }
    function ou(e, n) {
    ...
    function An(e, n, t, r, i, o, l, u, a) {
      ...
      function d(y) {
        return y === 60
          ? (e.enter(r), e.enter(i), e.enter(o), e.consume(y), e.exit(o), m)
          : y === null || y === 41 || sn(y)
          ? t(y)
          : (e.enter(r),
            e.enter(l),
      ...
      function m(y) {
        return y === 62
          ? (e.enter(o), e.consume(y), e.exit(o), e.exit(i), e.exit(r), n)
          : (e.enter(u),
            e.enter("chunkString", { contentType: "string" }),
            h(y))
      }
      function h(y) {
        return y === 62
          ? (e.exit("chunkString"), e.exit(u), m(y))
          : y === null || y === 60 || A(y)
          ? t(y)
          : (e.consume(y), y === 92 ? k : h)
      }
      function k(y) {
      ...
      function b(y) {
        return y === 40
          ...
          ? s--
            ? (e.consume(y), b)
            : (e.exit("chunkString"), e.exit(u), e.exit(l), e.exit(r), n(y))
          : y === null || Y(y)
          ? s
            ? t(y)
            : (e.exit("chunkString"), e.exit(u), e.exit(l), e.exit(r), n(y))
      ...
      function f(m) {
        return m === l
          ...
          ? (e.enter("lineEnding"),
            ...
            e.exit("lineEnding"),
            O(e, f, "linePrefix"))
          : (e.enter("chunkString", { contentType: "string" }), s(m))
      }
      function s(m) {
        return m === l || m === null || A(m)
          ? (e.exit("chunkString"), f(m))
          : (e.consume(m), m === 92 ? d : s)
      }
      function d(m) {
    ...
    var Pt = { name: "definition", tokenize: au },
      uu = { tokenize: su, partial: !0 }
    function au(e, n, t) {
      let r = this,
        i
      return o
          ...
          a === 58
            ? (e.enter("definitionMarker"),
              ...
              Re(
                ...
                An(
                  e,
                  e.attempt(uu, O(e, u, "whitespace"), O(e, u, "whitespace")),
                  t,
    ...
    var It = { name: "hardBreakEscape", tokenize: cu }
    function cu(e, n, t) {
      return r
      function r(o) {
        return (
          e.enter("hardBreakEscape"), e.enter("escapeMarker"), e.consume(o), i
        )
      }
      function i(o) {
        return A(o)
    ...
    var Ft = { name: "headingAtx", tokenize: fu, resolve: pu }
    function pu(e, n) {
      let t = e.length - 2,
        r = 3,
        i,
    ...
    function fu(e, n, t) {
      ...
      function l(s) {
        return s === 35 && i++ < 6
          ? (e.consume(s), l)
          : s === null || Y(s)
          ? (e.exit("atxHeadingSequence"), r.interrupt ? n(s) : u(s))
          : t(s)
      }
      function u(s) {
        return s === 35
          ? (e.enter("atxHeadingSequence"), a(s))
          : s === null || A(s)
          ? (e.exit("atxHeading"), n(s))
          : j(s)
          ? O(e, u, "whitespace")(s)
          : (e.enter("atxHeadingText"), f(s))
      }
      function a(s) {
        return s === 35
          ? (e.consume(s), a)
          : (e.exit("atxHeadingSequence"), u(s))
      }
      function f(s) {
        return s === null || s === 35 || Y(s)
          ? (e.exit("atxHeadingText"), u(s))
          : (e.consume(s), f)
      }
    }
    var mi = [
    ...
    var Tt = { name: "htmlFlow", tokenize: du, resolveTo: hu, concrete: !0 },
      mu = { tokenize: gu, partial: !0 }
    function hu(e) {
      let n = e.length
    ...
    function du(e, n, t) {
      ...
      function s(c) {
        return c === 33
          ...
          ? (e.consume(c), k)
          : c === 63
          ? (e.consume(c), (i = 3), r.interrupt ? n : oe)
          : ce(c)
          ? (e.consume(c), (l = String.fromCharCode(c)), (o = !0), b)
          : t(c)
      }
      function d(c) {
        return c === 45
          ? (e.consume(c), (i = 2), m)
          : c === 91
          ? (e.consume(c), (i = 5), (l = "CDATA["), (u = 0), h)
          : ce(c)
          ? (e.consume(c), (i = 4), r.interrupt ? n : oe)
          : t(c)
      }
      function m(c) {
      ...
      function h(c) {
        return c === l.charCodeAt(u++)
          ? (e.consume(c), u === l.length ? (r.interrupt ? n : D) : h)
          : t(c)
      }
      function k(c) {
      ...
      function b(c) {
        return c === null || c === 47 || c === 62 || Y(c)
          ? c !== 47 && o && Ot.includes(l.toLowerCase())
            ? ((i = 1), r.interrupt ? n(c) : D(c))
            : mi.includes(l.toLowerCase())
            ? ((i = 6),
              c === 47 ? (e.consume(c), w) : r.interrupt ? n(c) : D(c))
            : ((i = 7),
              r.interrupt && !r.parser.lazy[r.now().line]
                ...
                : y(c))
          : c === 45 || G(c)
          ? (e.consume(c), (l += String.fromCharCode(c)), b)
          : t(c)
      }
      function w(c) {
      ...
      function C(c) {
        return c === 45 || c === 46 || c === 58 || c === 95 || G(c)
          ? (e.consume(c), C)
          : B(c)
      }
      function B(c) {
      ...
      function P(c) {
        return c === null
          ? p(c)
          : A(c)
          ? e.attempt({ tokenize: M, partial: !0 }, P, p)(c)
          : (e.enter("htmlFlowData"), D(c))
      }
      function M(c, Ge, ve) {
        return He
        function He(ke) {
      ...
      function de(c) {
        return c === 62 && Ot.includes(l.toLowerCase())
          ? (e.consume(c), X)
          : ce(c) && l.length < 8
          ? (e.consume(c), (l += String.fromCharCode(c)), de)
          : D(c)
      }
      function K(c) {
    ...
    var Lt = { name: "htmlText", tokenize: yu }
    function yu(e, n, t) {
      let r = this,
        i,
        o,
      ...
      function w(p) {
        return p === o.charCodeAt(l++)
          ? (e.consume(p), l === o.length ? y : w)
          : t(p)
      }
      function y(p) {
        return p === null
      ...
      function $(p) {
        return p === 45 || p === 46 || p === 58 || p === 95 || G(p)
          ? (e.consume(p), $)
          : P(p)
      }
      function P(p) {
      ...
      function X(p) {
        return p === 62
          ? (e.consume(p), e.exit("htmlTextData"), e.exit("htmlText"), n)
          : t(p)
      }
    }
    var _e = { name: "labelEnd", tokenize: Eu, resolveTo: Su, resolveAll: wu },
      xu = { tokenize: Cu },
      ku = { tokenize: Au },
      bu = { tokenize: Pu }
    function wu(e) {
    ...
    function Su(e, n) {
      ...
      return (
        ...
        (u = ue(u, e.slice(o + 1, o + r + 3))),
        (u = ue(u, [["enter", s, n]])),
        (u = ue(
          u,
          Qe(n.parser.constructs.insideSpan.null, e.slice(o + r + 4, l - 3), n)
        )),
        (u = ue(u, [["exit", s, n], e[l - 2], e[l - 1], ["exit", f, n]])),
        (u = ue(u, e.slice(l + 1))),
        (u = ue(u, [["exit", a, n]])),
        ne(e, o, e.length, u),
        e
    ...
    function Eu(e, n, t) {
        ...
        return o
          ? o._inactive
            ...
            : ((l = r.parser.defined.includes(
                Ee(r.sliceSerialize({ start: o.end, end: r.now() }))
              )),
              e.enter("labelEnd"),
              e.enter("labelMarker"),
              e.consume(s),
      ...
      function a(s) {
        return s === 40
          ? e.attempt(xu, n, l ? n : f)(s)
          : s === 91
          ? e.attempt(ku, n, l ? e.attempt(bu, n, f) : f)(s)
          : l
          ? n(s)
          : f(s)
      }
    ...
    function Au(e, n, t) {
      ...
      function o(l) {
        return r.parser.defined.includes(
          Ee(r.sliceSerialize(r.events[r.events.length - 1][1]).slice(1, -1))
        )
          ? n(l)
          : t(l)
      }
    ...
    var Dt = { name: "labelStartLink", tokenize: Fu, resolveAll: _e.resolveAll }
    function Fu(e, n, t) {
      let r = this
      return i
      function i(l) {
    ...
    var fn = { name: "lineEnding", tokenize: Ou }
    function Ou(e, n) {
      return t
      function t(r) {
        return (
    ...
    var Be = { name: "thematicBreak", tokenize: Tu }
    function Tu(e, n, t) {
      let r = 0,
        i
      return o
      ...
      function l(a) {
        return a === i
          ? (e.enter("thematicBreakSequence"), u(a))
          : j(a)
          ? O(e, l, "whitespace")(a)
          : r < 3 || (a !== null && !A(a))
          ? t(a)
      ...
      function u(a) {
        return a === i
          ? (e.consume(a), r++, u)
          : (e.exit("thematicBreakSequence"), l(a))
      }
    }
    var re = {
        name: "list",
        tokenize: Du,
        continuation: { tokenize: zu },
        exit: _u
      },
      Lu = { tokenize: Bu, partial: !0 },
      vu = { tokenize: Ru, partial: !0 }
    function Du(e, n, t) {
      let r = this,
        ...
        if (
          ...
          if (
            ...
            return (
              ...
              h === 42 || h === 45 ? e.check(Be, t, f)(h) : f(h)
            )
          if (!r.interrupt || h === 49)
      ...
      function f(h) {
        return (
          ...
          e.check(Oe, r.interrupt ? t : s, e.attempt(Lu, m, d))
        )
      }
      function s(h) {
    ...
    function zu(e, n, t) {
      ...
      function i(u) {
        return (
          ...
          O(e, n, "listItemIndent", r.containerState.size + 1)(u)
        )
      }
      function o(u) {
    ...
    function Bu(e, n, t) {
      ...
      function i(o) {
        let l = r.events[r.events.length - 1]
        return !j(o) && l && l[1].type === "listItemPrefixWhitespace"
          ? n(o)
          : t(o)
      }
    }
    var Fn = { name: "setextUnderline", tokenize: Mu, resolveTo: Nu }
    function Nu(e, n) {
      let t = e.length,
        r,
        i,
    ...
    function Mu(e, n, t) {
      ...
      function a(s) {
        return s === o
          ? (e.consume(s), a)
          : (e.exit("setextHeadingLineSequence"), O(e, f, "lineSuffix")(s))
      }
      function f(s) {
      ...
      let n = this,
        t = e.attempt(
          ...
          e.attempt(
            ...
            O(
              e,
              e.attempt(this.parser.constructs.flow, i, e.attempt(At, i)),
              "linePrefix"
            )
          )
        )
    ...
    var di = { resolveAll: ki() },
      gi = xi("string"),
      yi = xi("text")
    function xi(e) {
      return { tokenize: n, resolveAll: ki(e === "text" ? Uu : void 0) }
      function n(t) {
        let r = this,
      ...
      for (; ++t <= e.length; )
        if (
          ...
          if (u) {
            ...
            ;(r.end = Object.assign({}, f.start)),
              r.start.offset === r.end.offset
                ? Object.assign(r, f)
                : (e.splice(t, 0, ["enter", f, n], ["exit", f, n]), (t += 2))
          }
          t++
        }
      return e
    ...
    function bi(e, n, t) {
      ...
      function h(P) {
        return (
          ...
          l[l.length - 1] !== null
            ? []
            : (Z(n, 0), (s.events = Qe(o, s.events, s)), s.events)
        )
      }
      function k(P, M) {
        return qu(b(P), M)
        ...
        for (; r._index < l.length; ) {
          ...
          if (typeof M == "string")
            for (
              ...
              r._index === P && r._bufferIndex < M.length;
      ...
      function B(P) {
        A(P)
          ? (r.line++, (r.column = 1), (r.offset += P === -3 ? 2 : 1), $())
      ...
      function N(P, M) {
        ...
        function J(ae, de, K) {
          ...
          function He(ee) {
            ...
            function Je(be) {
              return (
                (c = D()),
                (p = ee),
                ee.partial || (s.currentConstruct = ee),
                ee.name && s.parser.constructs.disable.null.includes(ee.name)
                  ? ke(be)
                  : ee.tokenize.call(
          ...
          function ke(ee) {
            return (a = !0), c.restore(), ++X < oe.length ? He(oe[X]) : K
          }
        }
      }
      function Z(P, M) {
      ...
      function D() {
        let P = w(),
          ...
          ae = s.events.length,
          de = Array.from(u)
        return { restore: K, from: ae }
        function K() {
          ;(r = P),
            (s.previous = M),
            (s.currentConstruct = J),
            (s.events.length = ae),
            (u = de),
            $()
        }
...
`
      ...
      function i(o, l, u) {
        ...
        for (
          ...
          if (
            ((Si.lastIndex = d),
            (f = Si.exec(o)),
            (m = f && f.index !== void 0 ? f.index : o.length),
            (h = o.charCodeAt(m)),
            !f)
          ) {
            n = o.slice(d)
          ...
          if (h === 10 && d === m && r) a.push(-3), (r = void 0)
          else
            switch (
              (r && (a.push(-5), (r = void 0)),
              d < m && (a.push(o.slice(d, m)), (e += m - d)),
              h)
            ) {
              case 0: {
                a.push(65533), e++
    ...
    function na(e) {
      ...
      function r(g) {
        ...
        for (; ++V < g.length; )
          if (
            g[V][1].type === "listOrdered" ||
            g[V][1].type === "listUnordered"
          )
            if (g[V][0] === "enter") H.push(V)
            else {
              let ge = H.pop()
              V = i(g, ge, V)
            }
        for (V = -1; ++V < g.length; ) {
          let ge = n[g[V][0]]
          Ii.call(ge, g[V][1].type) &&
            ge[g[V][1].type].call(
              Object.assign({ sliceSerialize: g[V][2].sliceSerialize }, I),
              g[V][1]
            )
        }
      ...
      function i(g, E, I) {
        ...
        for (; ++H <= I; ) {
          ...
          if (
            ...
            Q[1].type === "blockQuote"
              ? (Q[0] === "enter" ? V++ : V--, (nn = void 0))
              : Q[1].type === "lineEndingBlank"
              ? Q[0] === "enter" &&
                (Ae && !nn && !V && !en && (en = H), (nn = void 0))
              : Q[1].type === "linePrefix" ||
            ...
            if (Ae) {
              ...
              for (we = void 0; nt--; ) {
                ...
                if (
                  ...
                  we && ((g[we][1].type = "lineEndingBlank"), (ge = !0)),
                    (Se[1].type = "lineEnding"),
                    (we = nt)
                } else if (
                  !(
              ...
              en && (!we || en < we) && (Ae._spread = !0),
                (Ae.end = Object.assign({}, we ? g[we][1].start : Q[1].end)),
                g.splice(we || H, 0, ["exit", Ae, Q[2]]),
                H++,
                I++
            }
            Q[1].type === "listItemPrefix" &&
      ...
      function f(g, E, I) {
        return (
          ...
          this.stack.push(g),
          this.tokenStack.push([E, I]),
          (g.position = { start: Te(E.start) }),
          g
        )
      }
      function s(g) {
      ...
      function d(g, E) {
        ...
        if (H)
          H[0].type !== g.type &&
            (E ? E.call(this, g, H[0]) : (H[1] || Pi).call(this, g, H[0]))
        else
          throw new Error(
            "Cannot close `" +
              g.type +
              "` (" +
              Ie({ start: g.start, end: g.end }) +
              "): it\u2019s not open"
          )
      ...
      function k(g) {
        if (l("expectingFirstListItemValue")) {
          ...
          ;(E.start = Number.parseInt(this.sliceSerialize(g), 10)),
      ...
      function B(g) {
        ...
        ;(I.label = E),
          (I.identifier = Ee(this.sliceSerialize(g)).toLowerCase())
      }
      function z() {
        let g = this.resume(),
          E = this.stack[this.stack.length - 1]
      ...
      function ee(g) {
        let E = this.sliceSerialize(g),
          ...
          H
        I
          ? ((H = On(E, I === "characterReferenceMarkerNumeric" ? 10 : 16)),
      ...
      throw e
        ? new Error(
            "Cannot close `" +
              e.type +
              "` (" +
              Ie({ start: e.start, end: e.end }) +
              "): a different token (`" +
              n.type +
              "`, " +
              Ie({ start: n.start, end: n.end }) +
              ") is open"
          )
        : new Error(
...
`
    ...
    function fe(e) {
      ...
      for (; ++t < e.length; ) {
        let o = e.charCodeAt(t),
          l = ""
        if (o === 37 && G(e.charCodeAt(t + 1)) && G(e.charCodeAt(t + 2))) i = 2
        else if (o < 128)
    ...
    function qi(e, n, t) {
      ...
      if (typeof n.checked == "boolean") {
        ...
        s && s.type === "element" && s.tagName === "p"
          ...
          : ((d = {
            ...
            r.unshift(d)),
          d.children.length > 0 &&
            d.children.unshift({ type: "text", value: " " }),
          d.children.unshift({
            type: "element",
            tagName: "input",
      ...
      for (; ++u < r.length; ) {
        let s = r[u]
        ;(i || u !== 0 || s.type !== "element" || s.tagName !== "p") &&
          l.push({
            type: "text",
            value: `
`
          }),
          s.type === "element" && s.tagName === "p" && !i
            ? l.push(...s.children)
            : l.push(s)
      }
      let a = r[r.length - 1]
...
`
      ...
      let f = { type: "element", tagName: "li", properties: o, children: l }
    ...
    function Ki(e, n) {
      ...
      if (t.length > 0) {
        ...
        u.line && a.line && (l.position = { start: u, end: a }), i.push(l)
      }
      let o = {
        type: "element",
        tagName: "table",
    ...
    function Gi(e, n, t) {
      ...
      for (; ++a < u; ) {
        let d = n.children[a],
          ...
          h = l ? l[a] : void 0
        h && (m.align = h)
        let k = { type: "element", tagName: o, properties: m, children: [] }
        d && ((k.children = e.all(d)), e.patch(d, k), (k = e.applyData(n, k))),
          f.push(k)
      }
      let s = {
        type: "element",
    ...
    function eo(e) {
      let n = String(e),
        ...
        o = []
      for (; r; )
        o.push(Ji(n.slice(i, r.index), i > 0, !0), r[0]),
    ...
    function no(e, n) {
      let t = { type: "text", value: eo(String(n.value)) }
      return e.patch(n, t), e.applyData(n, t)
    }
    function to(e, n) {
        ...
        function l(u, a, f) {
          ...
          function d() {
            let m = [],
              ...
              b
            if (
              (!n || i(u, a, f[f.length - 1] || null)) &&
              ((m = aa(t(u, f))), m[0] === Rn)
            )
              return m
            if (u.children && m[0] !== Mt)
              for (
                k = (r ? u.children.length : -1) + o, b = f.concat(u);
                k > -1 && k < u.children.length;
    ...
    function lo(e, n) {
      ...
      return (
        ...
        (l.handlers = pe(pe({}, ro), t.handlers)),
        (l.definition = Ht(e)),
        (l.footnoteById = i),
        (l.footnoteOrder = []),
        (l.footnoteCounts = {}),
      ...
      function o(f, s) {
        if (f && "data" in f && f.data) {
          ...
          d.hName &&
            ...
            s.type === "element" &&
              d.hProperties &&
              (s.properties = pe(pe({}, s.properties), d.hProperties)),
            "children" in s &&
              s.children &&
              d.hChildren &&
              (s.children = d.hChildren)
        }
        if (f) {
          let d = "type" in f ? f : { position: f }
          Ut(d) || (s.position = { start: Ye(d), end: Ke(d) })
        }
        return s
      }
      function l(f, s, d, m) {
        return (
          Array.isArray(d) && ((m = d), (d = {})),
          o(f, {
            type: "element",
            tagName: s,
            properties: d || {},
    ...
    function ca(e, n) {
      ...
      if (e && e.data) {
        ...
        typeof r == "string" &&
          ...
          t.type === "element" &&
            o &&
            (t.properties = pe(pe({}, t.properties), o)),
          "children" in t &&
            t.children &&
            i !== null &&
            i !== void 0 &&
    ...
    function uo(e, n, t) {
      ...
      return _n.call(e.handlers, r)
        ? e.handlers[r](e, n, t)
        : e.passThrough && e.passThrough.includes(r)
        ? "children" in n
          ? Ve(pe({}, n), { children: qt(e, n) })
          : n
        : e.unknownHandler
    ...
    function pa(e, n) {
      let t = n.data || {},
        r =
          "value" in n &&
          !(_n.call(t, "hProperties") || _n.call(t, "hChildren"))
          ...
          children: [
            {
              ...
              properties: Ve(
                pe({}, JSON.parse(JSON.stringify(e.footnoteLabelProperties))),
                { id: "footnote-label" }
              ),
...
`
    ...
    var Qt = Object.keys(hn),
      je = class extends ie {
        constructor(n, t, r, i) {
          let o = -1
          if ((super(n, t), xo(this, "space", i), typeof r == "number"))
            for (; ++o < Qt.length; ) {
              let l = Qt[o]
            ...
            if (
              (e.allowedElements
                ...
                : e.disallowedElements &&
                  (l = e.disallowedElements.includes(t.tagName)),
              !l &&
                e.allowElement &&
                typeof r == "number" &&
                (l = !e.allowElement(t, r, o)),
              l && typeof r == "number")
            )
              return (
                e.unwrapDisallowed && t.children
                  ? o.children.splice(r, 1, ...t.children)
      ...
      for (; ++r < n.children.length; )
        (i = n.children[r]),
          i.type === "element"
            ? t.push(Na(e, i, r, n))
            : i.type === "text"
            ? (n.type !== "element" || !Ba.has(n.tagName) || !Fo(i)) &&
              t.push(i.value)
            : i.type === "raw" && !e.options.skipHtml && t.push(i.value)
      return t
    }
    function Na(e, n, t, r) {
      let i = e.options,
        ...
        s
      if (
        (l.space === "html" && u === "svg" && ((f = Eo), (e.schema = f)),
        n.properties)
      )
        for (s in n.properties)
          ir.call(n.properties, s) && ja(a, s, n.properties[s], e)
      ...
      if (!Uo.default.isValidElementType(h))
        throw new TypeError(
      ...
      if (
        ...
        !k && u === "li" && r.type === "element")
      ) {
        let b = Ma(n)
        ;(a.checked = b && b.properties ? !!b.properties.checked : null),
          (a.index = rr(r, n)),
      ...
      return (
        !k &&
          (u === "ol" || u === "ul") &&
          ((a.ordered = u === "ol"), (a.depth = e.listDepth)),
        (u === "td" || u === "th") &&
          (a.align &&
            (a.style || (a.style = {}),
        ...
        i.sourcePos && (a["data-sourcepos"] = qa(m)),
        !k && i.rawSourcePos && (a.sourcePosition = n.position),
        !k &&
          i.includeElementIndex &&
          ((a.index = rr(r, n)), (a.siblingCount = rr(r))),
        k || (a.node = n),
        d.length > 0
          ? Gn.default.createElement(h, a, d)
          : Gn.default.createElement(h, a)
      )
    }
    function Ma(e) {
      let n = -1
    ...
    function ja(e, n, t, r) {
      ...
      o == null ||
        o !== o ||
        (Array.isArray(o) && (o = i.commaSeparated ? To(o) : Oo(o)),
        i.property === "style" && typeof o == "string" && (o = Ua(o)),
        i.space && i.property
          ? (e[ir.call(jn, i.property) ? jn[i.property] : i.property] = o)
    ...
    function lr(e) {
      for (let o in Zn)
        if (Ho.call(Zn, o) && Ho.call(e, o)) {
          let l = Zn[o]
          console.warn(
            `[react-markdown] Warning: please ${
              l.to ? `use \`${l.to}\` instead of` : "remove"
            } \`${o}\` (see <${Va}#${l.id}> for more info)`
          ),
            delete Zn[o]
        }
      let n = kt()
          ...
          .use(
            Vt,
            Ve(pe({}, e.remarkRehypeOptions), { allowDangerousHtml: !0 })
          )
          .use(e.rehypePlugins || [])
          .use(Jt, e),
        t = new ze()
      ...
      let i = Jn.default.createElement(
        Jn.default.Fragment,
        {},
        or({ options: e, schema: So, listDepth: 0 }, r)
      )
      return (
        e.className &&
          (i = Jn.default.createElement("div", { className: e.className }, i)),
        i
      )
    }
    lr.propTypes = {
      ...
      remarkPlugins: F.default.arrayOf(
        F.default.oneOfType([
          F.default.object,
          F.default.func,
          F.default.arrayOf(
      ...
      rehypePlugins: F.default.arrayOf(
        F.default.oneOfType([
          F.default.object,
          F.default.func,
          F.default.arrayOf(
